#ifndef TRENLISTA_H_INCLUDED
#define TRENLISTA_H_INCLUDED
/******************************************************************************/
...
typedef struct{
    ...
    char imagen;
    int direccion;
    int tipo; //LOCOMOTORA O VAGON DE ORO ; VAGON DE COBRE; ETC
    int carga; //SI es locomotora, la carga serán monedas, si es vagón serán kilos de algo
}Dato;
